...
#SBATCH --partition=cook                # name of slurm partition to use for the main job
...
exec python ./src/dike.py ./config/satcomp25micro2.yml --requeue "$SLURM_SUBMIT_DIR/satcomp25micro2.slurm.sh"
